...
object Constants {
    const val ANG_PACKAGE = "namelessnet.org"
    ...
    const val PREF_LOGLEVEL = "pref_log_level"

    const val HTTP_PROTOCOL: String = "http://"
    const val HTTPS_PROTOCOL: String = "https://"

    const val BROADCAST_ACTION_SERVICE = "namelessnet.org.action.service"
    const val BROADCAST_ACTION_ACTIVITY = "namelessnet.org.action.activity"
    const val BROADCAST_ACTION_WIDGET_CLICK = "namelessnet.org.action.widget.click"
