...
import namelessnet.org.BuildConfig
...
object Utils {
    ...
    fun showInfoToast(context: Context, message: String) {
        FancyToast.makeText(context, message, FancyToast.LENGTH_SHORT, FancyToast.INFO, false)
            .show()
    }
    ...
    fun stopVService(context: Context) {
        ...
        MessageUtil.sendMsg2Service(context, Constants.MSG_STATE_STOP, "")
    }
    ...
    fun socketConnectTime(url: String, port: Int): Long {
        try {
            ...
            Log.d(Constants.ANG_PACKAGE, "socketConnectTime IOException: $e")
        } catch (e: Exception) {
            e.printStackTrace()
        }
        return -1
