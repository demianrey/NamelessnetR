...
import namelessnet.org.core.AppInfo
import namelessnet.org.databinding.ActivityBypassListBinding
...
class PerAppProxyActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val blacklist = defaultSharedPreferences.getStringSet(Constants.PREF_PER_APP_PROXY_SET, null)
...
//                }
        ...
        binding.switchPerAppProxy.setOnCheckedChangeListener { _, isChecked ->
            defaultSharedPreferences.edit().putBoolean(Constants.PREF_PER_APP_PROXY, isChecked).apply()
        }
        binding.switchPerAppProxy.isChecked = defaultSharedPreferences.getBoolean(Constants.PREF_PER_APP_PROXY, false)

        binding.switchBypassApps.setOnCheckedChangeListener { _, isChecked ->
            defaultSharedPreferences.edit().putBoolean(Constants.PREF_BYPASS_APPS, isChecked).apply()
        }
        binding.switchBypassApps.isChecked = defaultSharedPreferences.getBoolean(Constants.PREF_BYPASS_APPS, false)
    ...
    override fun onPause() {
        super.onPause()
        adapter?.let {
            defaultSharedPreferences.edit().putStringSet(Constants.PREF_PER_APP_PROXY_SET, it.blacklist).apply()
        }
    }
    ...
    private fun selectProxyApp() {
        ...
        val url = Constants.androidpackagenamelistUrl
