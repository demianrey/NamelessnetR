...
import namelessnet.org.databinding.ActivityServerCustomConfigBinding
...
class ServerCustomConfigActivity : BaseActivity() {
    ...
    private fun saveServer(): Boolean {
        ...
        val config = MmkvManager.decodeServerConfig(editGuid) ?: ServerConfig.create(protocols.PRIVATE)
